...
type RegistryDataProcessor struct {
...
func NewRegistryDataProcessor(ds importer.DataSourceInterface, dest DestinationRegistry, sha256Sum, md5Sum string) (*RegistryDataProcessor, error) {
	return &RegistryDataProcessor{
		ds,
		dest.Username,
		dest.Password,
		dest.ImageName,
...
func (p RegistryDataProcessor) Process(ctx context.Context) error {
...
func (p RegistryDataProcessor) inspectAndStreamSourceImage(
	ctx context.Context,
...
func (p RegistryDataProcessor) uploadLayersAndImage(
	ctx context.Context,
